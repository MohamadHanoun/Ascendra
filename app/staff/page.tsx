...
export const metadata: Metadata = {
  ...
  description:
    "Meet the people helping build, manage, and improve the Ascendra community.",
};
        ...
        <section className="relative overflow-hidden border-b border-white/10">
          ...
          <div className="relative z-10 mx-auto max-w-[1440px] px-6 py-20 lg:px-10">
            ...
            <p className="mt-6 max-w-2xl text-lg leading-8 text-gray-300">
              Meet the people helping manage Ascendra events, community tools,
              player experience, and tournament operations.
            </p>
          </div>
