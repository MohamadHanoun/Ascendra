...
const sections = [
  {
    title: "Use of Ascendra",
    description:
      "Ascendra is a tournament platform for gaming communities. By using the website or Discord-related features, you agree to use the service respectfully and only for its intended purpose.",
  },
  {
    title: "User accounts",
    description:
      "Some features require Discord login. You are responsible for the activity connected to your account, teams, invitations, and tournament registrations.",
  },
  {
    title: "Teams and tournaments",
    description:
      "Tournament rules, registration requirements, approvals, results, and rewards may be managed or updated by Ascendra administrators.",
  },
  {
    title: "Discord features",
    description:
      "The Ascendra Discord bot may create announcements, roles, and voice channels to support tournament management and team access.",
  },
  {
    title: "Updates",
    description:
      "These terms may be updated as Ascendra develops. Continued use of the service means you accept the latest version.",
  },
];
        ...
        <section className="relative min-h-[360px] overflow-hidden">
          ...
          <div className="relative z-10 mx-auto max-w-[1200px] px-6 pb-24 pt-20 lg:px-10">
            ...
            <p className="mt-5 max-w-2xl text-base leading-7 text-gray-300">
              Basic terms for using Ascendra features, teams, tournaments, and
        ...
        <section className="relative -mt-14 mx-auto grid max-w-[1200px] gap-8 px-6 pb-16 lg:px-10">
          <section className="rounded-3xl border border-white/10 bg-white/[0.04] p-5 shadow-2xl shadow-black/20">
            ...
            <p className="mt-3 max-w-3xl text-sm leading-7 text-gray-400">
              These terms explain the basic expectations for accounts, teams,
              tournament participation, and Discord-related automation.
            </p>
          </section>
