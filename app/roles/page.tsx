...
export const metadata: Metadata = {
  ...
  description:
    "Discover the main Ascendra roles and how they help organize the community.",
};
        ...
        <section className="relative overflow-hidden border-b border-white/10">
          ...
          <div className="relative z-10 mx-auto max-w-[1440px] px-6 py-20 lg:px-10">
            ...
            <h1 className="max-w-5xl text-5xl font-black uppercase leading-[1.02] tracking-tight text-white md:text-7xl">
              Roles that shape the community.
            </h1>

            <p className="mt-6 max-w-2xl text-lg leading-8 text-gray-300">
              Learn how Ascendra roles help organize players, staff,
              tournaments, and community responsibilities.
            </p>
          </div>
          ...
          {roles.length === 0 ? (
            <div className="rounded-3xl border border-white/10 bg-white/[0.04] p-8 text-center shadow-2xl shadow-black/20">
              <EmptyState
                ...
                description="Ascendra roles will appear here when they are available."
              />
            </div>
          ) : (
