...
function getButtonStyle(variant: InlineAdminRoleFormProps["variant"]): React.CSSProperties {
...
function getConfirmButtonStyle(variant: InlineAdminRoleFormProps["variant"]): React.CSSProperties {
