        ...
        >
          ...
          <div className="grid gap-4 lg:grid-cols-[minmax(0,1fr)_240px]">
            <label className="grid gap-2">
              ...
              <input name="title" required placeholder="Example: Tournament registration is open" className="border px-4 py-3 text-white outline-none transition" style={inputStyle} />
            </label>

            <label className="grid gap-2">
              <FieldLabel>Category</FieldLabel>
              <select name="category" required defaultValue="" className="border px-4 py-3 text-white outline-none transition" style={inputStyle}>
          ...
          <label className="grid gap-2">
            ...
            <textarea name="description" required placeholder="Write the announcement details..." className="min-h-24 resize-y border px-4 py-3 text-sm leading-6 text-white outline-none transition" style={inputStyle} />
          </label>
        </InlineAdminAnnouncementForm>
      </div>
    </section>
