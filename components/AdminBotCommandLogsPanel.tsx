...
export default async function AdminBotCommandLogsPanel() {
  ...
  const [logs, totalCount, completedCount, failedCount] = await Promise.all([
        ...
        <div className="mb-6 flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-3xl text-sm leading-6 text-gray-400">
              Review recent Discord slash command usage, failures, locations,
      ...
      <div className="rounded-3xl border border-white/10 bg-white/[0.04] p-6 shadow-2xl shadow-black/20">
        ...
        {logs.length === 0 ? (
          <div className="rounded-2xl border border-white/10 bg-black/20 p-6 text-sm text-gray-400">
            No slash command logs found yet.
          </div>
        ) : (
