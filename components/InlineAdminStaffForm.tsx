...
function getButtonStyle(variant: InlineAdminStaffFormProps["variant"]): React.CSSProperties {
...
function getConfirmButtonStyle(variant: InlineAdminStaffFormProps["variant"]): React.CSSProperties {
