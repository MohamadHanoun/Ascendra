...
function getButtonStyle(variant: InlineAdminRuleFormProps["variant"]): React.CSSProperties {
...
function getConfirmButtonStyle(variant: InlineAdminRuleFormProps["variant"]): React.CSSProperties {
