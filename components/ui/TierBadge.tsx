...
const tierStyles: Record<Tier, React.CSSProperties> = {
  Apex:     { color: "var(--asc-accent)",   borderColor: "oklch(0.50 0.20 285 / 0.4)",  background: "var(--asc-accent-dim)" },
  Diamond:  { color: "var(--asc-blue)",     borderColor: "oklch(0.55 0.12 220 / 0.5)",  background: "oklch(0.25 0.10 220 / 0.18)" },
  Platinum: { color: "oklch(0.78 0.10 175)",borderColor: "oklch(0.50 0.14 175 / 0.4)",  background: "oklch(0.20 0.08 175 / 0.18)" },
  Gold:     { color: "oklch(0.84 0.14 85)", borderColor: "oklch(0.60 0.18 85 / 0.4)",   background: "oklch(0.25 0.12 85 / 0.18)" },
