...
function getButtonStyle(variant: InlineAdminActionFormProps["variant"]): React.CSSProperties {
...
function getConfirmButtonStyle(variant: InlineAdminActionFormProps["variant"]): React.CSSProperties {
